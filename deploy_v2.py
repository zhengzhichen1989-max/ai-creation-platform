#!/usr/bin/env python3
"""Deploy frontend + proxy route fixes to production server via SFTP"""
...
SERVER_FILES = [
    ...
    "server/src/routes/proxy.routes.ts",
]
...
def restart_server(ssh):
    ...
    stdin, stdout, stderr = ssh.exec_command("sleep 2 && pm2 status 2>&1")
